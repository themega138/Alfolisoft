 ...
 * @author Moises
 */
public class BankAccountsDaoService extends GeneralService implements IBankAccountsService{
    ...
    public Long getBankAccountsCount() {
        return dao.get(Long.class, "select count(ba.id) from BankAccount as ba");
    }
